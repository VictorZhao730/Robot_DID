// Shared credential verification policy (CLI verifier and UI mirror this logic).
...
// EIP-191 verifyMessage over keccak256(canonical JSON without proof).
...
async function verifyCredentialPolicy(
  ...
  // --- Per-model checks (all must pass for result.valid) ---
